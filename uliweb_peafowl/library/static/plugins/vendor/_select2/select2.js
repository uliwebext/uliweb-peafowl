   ...
   */
    ...
    AbstractSelect2 = clazz(Object, {
                ...
                populateResults: function(container, results, query) {
                    ...
                    populate=function(results, container, depth) {
                        ...
                        for (i = 0, l = results.length; i < l; i = i + 1) {
                            ...
                            selectable = (!disabled) && (self.id(result) !== undefined);
        ...
        triggerChange: function (details) {
            ...
            /* limodou add select sync process
            if(this.select){
                if(details.added){
                    var flag = false;
                    var v = details.added;
        ...
        ensureHighlightVisible: function () {
            ...
            if (index === children.length - 1) {
                ...
                if (more.length > 0) {
                    ...
                    hb = more.offset().top + more.outerHeight(false);
                }
            }
    ...
    SingleSelect2 = clazz(AbstractSelect2, {
        ...
        setPlaceholder: function () {
            ...
            if (this.isPlaceholderOptionSelected() && placeholder !== undefined || this.select && !this.select.val()) {
    ...
    MultiSelect2 = clazz(AbstractSelect2, {
        ...
        initContainer: function () {
            ...
            // added sortable support by limodou 2014/12/17
            // according to https://github.com/ivaynberg/select2/issues/1190
            if (this.opts.tagsSortable)
                this.enableSortable();
        },

        /*added by limodou 2014/12/17
          this function needs jquery-ui
          */
        enableSortable: function(){
            var that = this;
            this.container.sortable({
                placeholder : 'select2-search-choice select2-sortable-choice',
